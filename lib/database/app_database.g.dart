...
class $WorkoutSessionsTable extends WorkoutSessions
  ...
  static const VerificationMeta _sessionTagsJsonMeta =
      const VerificationMeta('sessionTagsJson');
  @override
  late final GeneratedColumn<String> sessionTagsJson = GeneratedColumn<String>(
      'session_tags_json', aliasedName, false,
    ...
    if (data.containsKey('session_tags_json')) {
      context.handle(
          ...
          sessionTagsJson.isAcceptableOrUnknown(
              data['session_tags_json']!, _sessionTagsJsonMeta));
    }
  ...
  WorkoutSession map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return WorkoutSession(
      ...
      sessionTagsJson: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}session_tags_json'])!,
...
class WorkoutSession extends DataClass implements Insertable<WorkoutSession> {
  ...
  @override
  int get hashCode => Object.hash(id, routineId, routineName, startedAt,
      finishedAt, durationSeconds, totalVolume, sessionTagsJson, notes);
  @override
...
class WorkoutExercise extends DataClass implements Insertable<WorkoutExercise> {
  ...
  @override
  int get hashCode => Object.hash(id, sessionId, exerciseId, exerciseName,
      muscleGroup, tagsJson, isCustom, sortOrder);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class WorkoutSet extends DataClass implements Insertable<WorkoutSet> {
  ...
  int get hashCode => Object.hash(id, workoutExerciseId, setNumber, reps,
      weight, restSeconds, isWarmup, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is WorkoutSet &&
...
class $ProfileRecordsTable extends ProfileRecords
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, alias, goal, heightCm, targetWeight, age];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<ProfileRecord> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
...
class $BodyProgressRecordsTable extends BodyProgressRecords
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, date, weight, waist, chest, arm, thigh, bodyFat];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<BodyProgressRecord> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  BodyProgressRecord map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return BodyProgressRecord(
      ...
      arm: attachedDatabase.typeMapping
          .read(DriftSqlType.double, data['${effectivePrefix}arm']),
...
class BodyProgressRecord extends DataClass
  ...
  factory BodyProgressRecord.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return BodyProgressRecord(
      id: serializer.fromJson<String>(json['id']),
...
class $CustomExercisesTable extends CustomExercises
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, muscleGroup, tagsJson, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class $$WorkoutSessionsTableAnnotationComposer
  ...
  GeneratedColumn<String> get sessionTagsJson => $composableBuilder(
      column: $table.sessionTagsJson, builder: (column) => column);
...
class $$WorkoutSetsTableTableManager extends RootTableManager<
    ...
    (WorkoutSet, BaseReferences<_$AppDatabase, $WorkoutSetsTable, WorkoutSet>),
    WorkoutSet,
    PrefetchHooks Function()> {
...
typedef $$WorkoutSetsTableProcessedTableManager = ProcessedTableManager<
    ...
    WorkoutSet,
    PrefetchHooks Function()>;
typedef $$ProfileRecordsTableCreateCompanionBuilder = ProfileRecordsCompanion
    Function({
  required String id,
  required String alias,
  required String goal,
...
typedef $$ProfileRecordsTableUpdateCompanionBuilder = ProfileRecordsCompanion
    Function({
  Value<String> id,
  Value<String> alias,
  Value<String> goal,
...
class $$ProfileRecordsTableTableManager extends RootTableManager<
    _$AppDatabase,
    $ProfileRecordsTable,
    ProfileRecord,
    $$ProfileRecordsTableFilterComposer,
  ...
  $$ProfileRecordsTableTableManager(
      _$AppDatabase db, $ProfileRecordsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
typedef $$ProfileRecordsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $ProfileRecordsTable,
    ProfileRecord,
    $$ProfileRecordsTableFilterComposer,
...
class $$BodyProgressRecordsTableTableManager extends RootTableManager<
    _$AppDatabase,
    ...
    (
      BodyProgressRecord,
      BaseReferences<_$AppDatabase, $BodyProgressRecordsTable,
          BodyProgressRecord>
    ),
    BodyProgressRecord,
    PrefetchHooks Function()> {
  $$BodyProgressRecordsTableTableManager(
      _$AppDatabase db, $BodyProgressRecordsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
typedef $$BodyProgressRecordsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $BodyProgressRecordsTable,
    BodyProgressRecord,
    $$BodyProgressRecordsTableFilterComposer,
...
class $$CustomExercisesTableTableManager extends RootTableManager<
  ...
  $$CustomExercisesTableTableManager(
      _$AppDatabase db, $CustomExercisesTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
typedef $$CustomExercisesTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $CustomExercisesTable,
    CustomExercise,
    $$CustomExercisesTableFilterComposer,
